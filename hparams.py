...
class Hparams:
    ...
    parser.add_argument('--gpu', default='0', help='choosing gpu')
    parser.add_argument('--id', default='0', help='id')
    parser.add_argument('--eval_every_n_second', default=3600, type=int)
    # prepro
    parser.add_argument('--en_vocab_size', default=3000, type=int)
    parser.add_argument('--ch_vocab_size', default=3000, type=int)
    ...
    ## vocabulary
    parser.add_argument('--en_vocab', default='iwslt2016/segmented/bpe.vocab',
                        help="vocabulary file path")
    parser.add_argument('--ch_vocab', default='iwslt2016/segmented/bpe.vocab',
                        help="vocabulary file path")
    ...
    parser.add_argument('--logdir', default="../mt_log/", help="log directory")
